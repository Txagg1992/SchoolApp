...
import com.curiousapps.schoolapp.AppExecutors;
...
import static com.curiousapps.schoolapp.util.Constants.NETWORK_TIMEOUT;
...
public class SchoolApiClient {
    ...
    private class RetrieveSchoolSatRunnable implements Runnable{
        ...
        private Call<List<SchoolSAT>> getSchoolSat(String dbn){
            return ServiceGenerator.getSatApi().getSchoolSat(
                    APP_TOKEN,
                    dbn
            );
        }
